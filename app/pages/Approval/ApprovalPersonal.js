          ...
          <CardItem>
            <Left>
              <Body>
                ...
                <Text>Order By           : {this.props.data.NO_BADGE}</Text>
                <Text>Employee Name : {this.props.data.NAMA}</Text>
                <Text>Employee Unit / Diviton : {this.props.data.UK_TEXT}</Text>
              </Body>
            </Left>
          </CardItem>
          <CardItem>
            <Left>
              <Body>
                ...
                <Text>Order Date              : {this.props.data.CREATE_AT}</Text>
              </Body>
            </Left>
          </CardItem>
          <CardItem>
            <Right>
              <Body>
                <Text style={{fontWeight: 'bold'}} onPress={() => this.navigateToScreen('ActionsPersonal', this.props.data.ID)}>Actions</Text>
              </Body>
            </Right>
          </CardItem>
        </Card>
