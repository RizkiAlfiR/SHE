...
export default class ActionsPinjam extends Component {
  constructor(props) {
    super(props);
    this.state = {
      active: 'true',
  ...
  loadData(id) {
    AsyncStorage.getItem('token').then((value) => {
      ...
      const url = GlobalConfig.SERVERHOST + 'api/v1/apd/approve/detail/pinjam/' + id;
  ...
  rejectPinjam() {
    // AsyncStorage.getItem('token').then((value) => {
      ...
      const url = GlobalConfig.SERVERHOST + 'api/v1/apd/approve/reject/pinjam/PJM-' + this.state.id;
      var formData = new FormData();
  ...
  approvePinjam() {
    // alert(JSON.stringify(value));
    const url = GlobalConfig.SERVERHOST + 'api/v1/apd/approve/pinjam';
    var formData = new FormData();
                ...
                <ScrollView>
                  <View style={styles.content}>
                    <View style={styles.inputContainer}>
                      ...
                      <Text style={styles.logo}>List Detail Peminjaman APD</Text>
