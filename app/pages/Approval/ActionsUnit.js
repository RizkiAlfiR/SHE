...
export default class ActionsUnit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      active: 'true',
  ...
  rejectUnit() {
    ...
    const url = GlobalConfig.SERVERHOST + 'api/v1/apd/approve/reject/order/RUK-' + this.state.id;
    var formData = new FormData();
                ...
                <ScrollView>
                  <View style={styles.content}>
                    <View style={styles.inputContainer}>
                      ...
                      <Text style={styles.logo}>List Detail Unit Kerja APD</Text>
