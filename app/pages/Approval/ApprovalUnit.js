          ...
          <CardItem>
            <Left>
              <Body>
                ...
                <Text style={styles.cardtext}>Penanggung Jawab     : {this.props.data.NAMA}</Text>
                <Text style={styles.cardtext}>Unit Kerja           : {this.props.data.UK_TEXT}</Text>
              </Body>
            </Left>
          </CardItem>
          <CardItem>
            <Left>
              <Body>
                <Text style={{fontSize: 15}}>Tanggal Order        : {this.props.data.CREATE_AT}</Text>
              </Body>
            </Left>
          </CardItem>
          <CardItem>
            <Left>
              <Body>
                <Button style={{ borderRadius: 5, backgroundColor: '#f8ac59', marginTop: 10 }}>
                  <Text style={{ fontWeight: 'bold', color: '#ffffff', marginLeft: 10, marginRight: 10 }} onPress={() => this.navigateToScreen('ActionsUnit', this.props.data.ID)}>Actions</Text>
                </Button>
              </Body>
            </Left>
          </CardItem>
                ...
                <ScrollView>
                  <View style={styles.content}>
                    <View style={styles.inputContainer}>
                      <Text style={styles.logo}>Approval Permintaan Unit Kerja</Text>
