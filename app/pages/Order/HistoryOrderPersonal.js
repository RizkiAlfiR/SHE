...
import { Image, FlatList, AsyncStorage, ActivityIndicator, StyleSheet, KeyboardAvoidingView, ScrollView, ImageBackground } from 'react-native';
          ...
          <CardItem>
            <Left>
              <Body>
                ...
                <Text>Nama              : {this.props.data.NAME}</Text>
...
export default class HistoryOrderPersonal extends Component {
  static navigationOptions = {
    title: 'History Order Personal'
  };
                ...
                <ScrollView>
                  <View style={styles.content}>
                    <View style={styles.inputContainer}>
                      <Text style={styles.logo}>History Order Personal</Text>
